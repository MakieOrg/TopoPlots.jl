...
@deprecate eeg_topoplot(data::AbstractVector{<:Real}, labels::Vector{<:AbstractString}) eeg_topoplot(data;
                                                                                                     labels)
@deprecate eeg_topoplot!(fig, data::AbstractVector{<:Real},
                         labels::Vector{<:AbstractString}) eeg_topoplot!(fig, data; labels)
...
function draw_ear_nose!(parent, circle; kw...)
    ...
    head_points = lift(circle) do circle
        ...
        append!(points, nose)
        ear = (Point2f[(0.497, 0.0555), (0.51, 0.0775), (0.518, 0.0783),
    ...
    return lines!(parent, head_points; kw...)
end
...
const CHANNELS_10_05 = ["af1", "af10", "af10h", "af1h", "af2", "af2h", "af3", "af3h",
                        ...
                        "afp1", "afp10", "afp10h", "afp1h", "afp2", "afp2h", "afp3",
                        "afp3h",
                        ...
                        "ccp5h", "ccp6", "ccp6h", "ccpz", "cp1", "cp1h", "cp2", "cp2h",
                        "cp3",
                        "cp3h", "cp4", "cp4h", "cp5", "cp5h", "cp6", "cp6h", "cpp1",
                        "cpp1h",
                        ...
                        "ffc6h", "ffcz", "fft10", "fft10h", "fft7", "fft7h", "fft8",
                        "fft8h",
                        "fft9", "fft9h", "ft10", "ft10h", "ft7", "ft7h", "ft8", "ft8h",
                        "ft9",
                        "ft9h", "ftt10", "ftt10h", "ftt7", "ftt7h", "ftt8", "ftt8h", "ftt9",
                        "ftt9h", "fp1", "fp1h", "fp2", "fp2h", "fpz", "fz", "i1", "i1h",
                        "i2",
                        "i2h", "iz", "lpa", "n1", "n1h", "n2", "n2h", "nas", "nfp1",
                        "nfp1h",
                        "nfp2", "nfp2h", "nfpz", "nz", "o1", "o1h", "o2", "o2h", "oi1",
                        "oi1h",
                        ...
                        "tp10", "tp10h", "tp7", "tp7h", "tp8", "tp8h", "tp9", "tp9h",
                        "tpp10",
...
const CHANNELS_10_20 = ["fp1", "f3", "c3", "p3", "o1", "f7", "t3", "t5", "fz", "cz", "pz",
